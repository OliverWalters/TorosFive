...
if ($equipos != null) {
    foreach ($equipos as $equipo) {
        ...
        '<li class="tbl__row">
            ...
            <div class="tbl__col tbl__col--4" data-label="Gestionar"><a href="gestionarEquipo.php?team=' . $equipo->getIdequipo() . '"><i class="fa-solid fa-gear" style="color: #555;font-size: 20px"></i></a></div>
