...
if ($equipos != null) {
    foreach ($equipos as $equipo) {
        ...
        '<li class="tbl__row">
            ...
            <div class="tbl__col tbl__col--4" data-label="Gestionar"><a href="gestionarEquipo.php?team=' . $equipo->getIdequipo() . '"><i class="fa-solid fa-gear"></i></a></div>
            <div class="tbl__col tbl__col--5" data-label="Editar"><a href="editEquipo.php?team=' . $equipo->getIdequipo() . '"><i class="fa-solid fa-pen-to-square"></i></a></div>
            <div class="tbl__col tbl__col--6" data-label="Eliminar"><button class="deleteBtn" onclick="mensajeConfirmar(\'borrarEquipo.php?team=' . $equipo->getIdequipo() . '\')"><i class="fa-solid fa-trash"></i></button></div>
