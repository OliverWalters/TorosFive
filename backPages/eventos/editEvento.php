...
if($_SERVER["REQUEST_METHOD"] == "GET"){
    $result = $entityManager->getRepository('Evento')->find($_GET["event"]);
}
...
<html>
    ...
    <body class="body--margin">
        ...
        ?>
        <form class="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?event=" . $_GET["event"];?>" method="post" enctype="multipart/form-data">
