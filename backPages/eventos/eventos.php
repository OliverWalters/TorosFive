...
<div class="tbl">
    <h2 class="tbl__title"><i class="fa-regular fa-calendar tbl__icono"></i> Gestión de eventos<small class="tbl__subtitle"></small></h2>
    ...
    <button class="tbl__btn--add tbl__btn" onclick="window.location.href='agregarEvento.php';"><i class="fa-solid fa-user-plus" style="margin-right:5px;"></i>  Añadir</button>
